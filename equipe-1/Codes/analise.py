...
class Analise():
    ...
    def _run_binary(self, binary: str, input_file: str):
        ...
        try:
            ...
            logging.error(f"Error running binary {binary} with input {input_file} : {stderr}")
            return None
    ...
    def run(self,input_category, num_tests: int = 13):
        ...
        for binary in self.algoritimos:
            print("\nAnalisando o algoritimo: {} ".format(binary) )
            for category in input_category:
                ...
                for input_file in tqdm(category):
                    ...
                    for test_number in range(num_tests):
                        result = self._run_binary(binary, self.diretorio + input_file)
                    ...
                    logging.debug(f"Execution {binary} - {input_file} - Time {media} milisegundos")
